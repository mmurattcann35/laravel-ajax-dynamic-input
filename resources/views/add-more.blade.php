...
<div class="container">
    <h2 align="center">Dynamic Input Fields with Laravel - Murat CAN</h2>

    <form action="{{ route('add.input') }}" method="POST">
        @csrf
        ...
        $("#add").click(function() {
            ...
            $("#dynamicTable").append(
                '<tr>' +
                    ...
                    '</td>' +
                    '<td><' +
                    'input type="text" name="addmore['+i+'][qty]" placeholder="Enter Quantity" class="form-control">' +
                    '</td>' +
                    '<td><' +
